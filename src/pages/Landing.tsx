        ...
        <div className="min-h-screen flex flex-col">
            <header style={{ padding: '1rem 0', borderBottom: '1px solid var(--border-color)' }}>
                <div className="container" style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                    ...
                    <nav>
                        <Link to="/dashboard" className="btn-primary" style={{ textDecoration: 'none', fontSize: '0.9rem', padding: '0.5rem 1rem' }}>
                            Launch App
                        </Link>
                    </nav>
                </div>
            ...
            <main className="container" style={{ padding: '4rem 0', textAlign: 'center', flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
                ...
                <div>
                    <Link to="/dashboard" className="btn-primary" style={{ display: 'inline-block', fontSize: '1.1rem', padding: '1rem 2rem' }}>
                        Get Started
                    </Link>
                </div>
            </main>
